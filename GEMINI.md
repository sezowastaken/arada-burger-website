...
6. **Technical Integrity:** Keep code understandable for junior developers. Follow existing patterns and naming conventions found in the source of truth (the actual files).
